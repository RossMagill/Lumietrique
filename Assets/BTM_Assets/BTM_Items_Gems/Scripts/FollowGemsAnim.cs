...
{
    public class FollowGemsAnim : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            // 💡 FIX 1: Store the position relative to the PARENT (the stack/robot)
        ...
        void Update()
        {
            if (isRotating)
            {
                ...
                // 💡 FIX 2: Continue using transform.Rotate, which is relative by default
            ...
            if (isFloating)
            {
                ...
                // 💡 FIX 3: Apply the animation displacement to the LOCAL position
